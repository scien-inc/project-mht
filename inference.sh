...
# VIDEO_PATH="./gsam2/notebooks/videos/5FPS/141333656.mp4"
# OUTPUT_DIR="./data/frames"
# OUTPUT_DIR_GSAM2="./data/gsam2_output"
# DURATION=30
# INTERVAL=10

# python module/split.py --video_path "$VIDEO_PATH" --output_base_dir "$OUTPUT_DIR" --duration $DURATION --interval $INTERVAL
